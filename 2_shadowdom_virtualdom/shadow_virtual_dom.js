//🚩Shadow DOM
//Shadow DOM allows hidden dom tree to be attached to element in the regular/real DOM tree.
//Shadow DOM is used for designed web component.(video element, input type="range", audio etc.)
...
//The Virtual DOM not strored on hard drive or in a permanent location. It is dynamically created, updated,
//and discarded during the lifecycle of React Application or the app is active or runs in user's browser.
...
//  represents to update the changes in UI. Then React compares the Previous Virtual DOM(before update created),
//  with the new Virtual DOM to find the "changes" or "differnces" this process is called as "diffing"(diff algorithm).
